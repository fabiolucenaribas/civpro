"use strict";(self.webpackChunkapp=self.webpackChunkapp||[]).push([["node_modules_ionic_core_dist_esm_index-c4b11676_js-node_modules_ionic_core_dist_esm_ion-infin-38f70c"],{4147:(u,c,t)=>{t.d(c,{a:()=>o,b:()=>n,p:()=>a});
/*!
     * (C) Ionic http://ionicframework.com - MIT License
     */
const a=(s,...l)=>console.warn(`[Ionic Warning]: ${s}`,...l),n=(s,...l)=>console.error(`[Ionic Error]: ${s}`,...l),o=(s,...l)=>console.error(`<${s.tagName.toLowerCase()}> must be used inside ${l.join(" or ")}.`)},8034:(u,c,t)=>{t.r(c),t.d(c,{ion_infinite_scroll:()=>f,ion_infinite_scroll_content:()=>g});var a=t(5861),n=t(7936),o=t(1671),s=t(8935),l=t(8439);
/*!
     * (C) Ionic http://ionicframework.com - MIT License
